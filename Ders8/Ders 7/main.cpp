...
#define RESOURCE_PATH "C://Users/User/Desktop/lessons/dönem8/bilgisayar proje 2/OpenGL_Tests/Ders8/Ders 7/Ders 7/"
#ifdef _WIN32
#include <windows.h>
#include <GL/glew.h>
#include <GL/GL.h>
...
void setupScene(){
	...
	glBindFramebuffer(GL_FRAMEBUFFER,fbo_texture); // bind fbo
	glViewport(0,0,CurrentWidth,CurrentHeight);
	glClear(GL_COLOR_BUFFER_BIT | GL_DEPTH_BUFFER_BIT);
/*
...
*/
	unsigned char* image = SOIL_load_image("sampleTex.tga", &CurrentWidth, &CurrentHeight,0, SOIL_LOAD_RGB);
	glTexImage2D( GL_TEXTURE_2D, 0, GL_RGB, CurrentWidth, CurrentHeight, 0, GL_RGB, GL_UNSIGNED_BYTE, image );
